...
centring.year       <- 2000                                                            # Used to centre time
...
country.file.name   <- "country-list-2023.csv"
metadata.file.name  <- "metadata_glucose_raw.csv"



outdirname <- paste0(variable, "_", sex, "/")                                           # Set up output directory
...
filename            <- paste0("Model",mod.no,"_",sex,"_",variable,"_Seed_",seedVal)     # Sets a base filename used throughout the code
...
source("NCD_RisC_commented_prevalence_code_FUNCTIONS.R")                            # Loads functions
